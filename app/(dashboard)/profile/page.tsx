      ...
      <div className="mt-5 space-y-2">
        <div className="min-w-full rounded gap-5">
          <div className="px-4 py-6 rounded-md bg-white dark:bg-darker">
            <span className="text-gray-600 font-bold">Regulator Details</span>
            <div className="flex flex-col space-y-2 mt-2">
              <div className="flex flex-wrap">
                <div className="flex flex-1 gap-3">
                  <label className="text-sm font-medium">Name {":"}</label>
                  <span className="text-sm">
                    {stateContext.state.authUser?.regulator.name}
                  </span>
                </div>
                <div className="flex flex-1 gap-3">
                  ...
                  <span className="text-sm">
                    {stateContext.state.authUser?.regulator.email_domain}
                  </span>
                </div>
              </div>
            </div>
